...
Theoretically, this allows data transfers three times faster than
standard [GPRS](gprs.md), but is not always the case. The
maxinmum data transfer rate is 236 kbps but most networks running EDGE are
...
the core network, the base station subsystem only need a transceiver
